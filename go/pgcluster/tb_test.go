...
// recordingTB stands in for a test's TB so this package's own failure paths can
...
// test's lifetime.
//
// This is a deliberate copy of the hygiene package's harness rather than a
// shared one: each package in this module is meant to be readable on its own,
// and a test-only helper is not worth an export.
